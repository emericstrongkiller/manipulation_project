...
: ${AMENT_CURRENT_PREFIX:="/home/user/ros2_ws/src/manipulation_project/install/moveit2_scripts"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/moveit2_scripts/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/moveit2_scripts/environment/path.sh"
