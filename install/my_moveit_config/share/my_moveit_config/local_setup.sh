...
: ${AMENT_CURRENT_PREFIX:="/home/user/ros2_ws/src/manipulation_project/install/my_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_moveit_config/environment/path.sh"
