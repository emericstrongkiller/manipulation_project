...
class StaticTransformPublisher:
    ...
    def publish_static_transform(self) -> None:
        ...
        static_transform_stamped.transform.translation.x = 0.5 + 0.06 # offset because wierd tf on camera part
        static_transform_stamped.transform.translation.y = 0.605
        static_transform_stamped.transform.translation.z = 0.100
        static_transform_stamped.transform.rotation.x = 0.0
        static_transform_stamped.transform.rotation.y = 0.766  
        static_transform_stamped.transform.rotation.z = -0.643
